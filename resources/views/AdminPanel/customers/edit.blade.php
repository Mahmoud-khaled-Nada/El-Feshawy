    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                enctype="multipart/form-data" action="{{ route('employees.update', $employee->id) }}" method="POST">
                <!--begin::Card body-->
                @include('AdminPanel.employees.fields')
                <!--end::Card body-->
        </div>
        <!--begin::Actions-->
        <div class="card-footer d-flex justify-content-end py-6 px-9">
            <a type="button" class="btn btn-light btn-active-light-primary me-2"
                href='{{ route('employees.index') }}'>{{ __('lang.back') }}</a>
