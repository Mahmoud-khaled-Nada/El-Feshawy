...
@section('content')
    <x-toolbar title="{{ __('lang.services') }}" />
    <x-partials-errors />
    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                novalidate="novalidate" enctype="multipart/form-data" action="{{ route('services.update', $service->id) }}"
                method="POST">
                <!--begin::Card body-->
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a type="button" class="btn btn-light btn-active-light-primary me-2"
                        href='{{ route('services.index') }}'>{{ __('lang.back') }}</a>
