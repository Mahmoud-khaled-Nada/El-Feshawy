            ...
            @if (auth()->user()->can('create employees'))
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('employees.import') }}"
                        class="btn btn-sm fw-bold btn-primary">{{ __('lang.import') }}</a>
                    <a href="{{ asset('examples/employees.xlsx') }}" download
                        class="btn btn-sm fw-bold btn-primary">{{ __('lang.try_example') }}</a>
                </div>
            @endif
            <!--end::Actions-->
        </div>
    ...
    <div class="card mb-5 mb-lg-10">
        ...
        <div class="card-body p-0 m-2">
            ...
            <div class="table-responsive" id="kt_datatable">
                @include('AdminPanel.employees.table')
            </div>
            <!--end::Table wrapper-->
        </div>
        <!--end::Card body-->
