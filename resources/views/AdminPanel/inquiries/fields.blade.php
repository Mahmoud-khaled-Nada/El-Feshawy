...
<div class="card-body border-top p-9">
    ...
    <div class="tab-content mt-5" id="myTabContent">
        @foreach (LaravelLocalization::getSupportedLocales() as $name => $value)
            <div class="tab-pane fade {{ LaravelLocalization::getCurrentLocale() == $name ? 'show active' : '' }}"
                ...
                <div class="row mb-3">
                    <!--begin::Label-->
                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('lang.subject') }}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                        <!--begin::Row-->
    ...
    <div class="row mb-3">
        <!--begin::Col-->
        <div class="col-lg-4">
            <label class="col-form-label required fw-semibold fs-6">Start time</label>
            <input type="time" name="start_time" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                placeholder="start time" value="{{ old('start_time', $meeting->start_time ?? '') }}">
        ...
        <!--begin::Col-->
        <div class="col-lg-4">
            <label class="col-form-label required fw-semibold fs-6">End time</label>
            <input type="time" name="end_time" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                placeholder="end time" value="{{ old('end_time', $meeting->end_time ?? '') }}">
            <div class="invalid-feedback">
        ...
        <div class="col-lg-4">
            ...
            <input type="date" name="date" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                placeholder="date" value="{{ old('date', $meeting->date ?? '') }}">
            <div class="invalid-feedback">
                <!-- Error message for end time -->
            </div>
        </div>
    ...
    <div class="row mb-3">
        <!--begin::Col-->
        <div class="col-lg-4">
            <label class="col-form-label required fw-semibold fs-6">Number of employees</label>
            <input type="number" name="number_employees"
                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="number employees..."
        ...
        <!--begin::Col-->
        <div class="col-lg-4">
            <label class="col-form-label required fw-semibold fs-6">Number of Customer</label>
            <input type="number" name="number_customers" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                placeholder="number customers..." value="{{ old('number_customers', $meeting->number_customers ?? '') }}">
            <div class="invalid-feedback">
                <!-- Error message for end time -->
            </div>
        </div>
    ...
    <div class="row mb-3" id="meeting-link-group">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Meeting link</label>
        <!--end::Label-->
        <!--begin::Col-->
        <div class="col-lg-8">
            <!--begin::Row-->
            <div class="row">
                ...
                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                    <input type="text" name="link"
                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="link..."
    ...
    <div class="row mb-3" id="meeting-location-group">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Meeting location</label>
        <!--end::Label-->
        <!--begin::Col-->
        <div class="col-lg-8">
            <!--begin::Row-->
            <div class="row">
                ...
                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                    <input type="text" name="location"
                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="location..."
    ...
    <div class="row mb-3">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Employees</label>
        <!--end::Label-->
    ...
    <div class="row mb-3">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Customers</label>
        <!--end::Label-->
                ...
                <div class="col-lg-12 fv-row fv-plugins-icon-container">
                    <select id="customer-select" class=" form-control select2 h-50px" multiple name="customer_ids[]">
                        <option value="{{ $customer->id }}"
                            {{ collect(old('customer_ids', isset($customer) ? $customer->id : []))->contains($customer->id) ? 'selected' : '' }}>
                            {{ $customer->name }}
                        </option>
                    </select>
                </div>
